...
#PREVIEW_CAPS = gst.caps_from_string ('video/x-raw-yuv,width=640,height=480,rate=30')
#H264_CAPS = gst.caps_from_string ('video/x-h264,width=1280,heigth=720,framerate=30/1,profile=high')
##H264_CAPS = gst.caps_from_string ('video/x-h264,width=1920,heigth=1080,framerate=30/1,profile=high')

PREVIEW_CAPS = gst.caps_from_string ('image/jpeg,width=640,height=480,rate=30')
H264_CAPS = gst.caps_from_string ('video/x-h264,width=1024,heigth=576,framerate=30/1,profile=high')

AUDIO_CAPS = gst.caps_from_string ('audio/x-raw,format=S16LE,rate=32000,channels=2')
